...
): UserDetails
{
    ...
    override fun isCredentialsNonExpired(): Boolean { return this.enabled }
    override fun isAccountNonExpired(): Boolean { return this.enabled }
    override fun isAccountNonLocked(): Boolean { return this.enabled }
